 ...
 *   \date Time-stamp: <2016-09-13 11:17:23 ritt>
 *
...
void gra(ostream& o, const Instance& I, Solution& S, Constructor construct, unsigned rep, double alpha, chrono::system_clock::time_point start) {
  Solution B(I);
  B = S;
...
void grasp(const Instance& I, Solution& S, Constructor construct, unsigned rep, double alpha, Improver improve, chrono::system_clock::time_point start) {
  Solution B(I);
  B = S;
